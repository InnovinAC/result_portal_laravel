...
<?php $__env->startSection('content'); ?>
    <div class="alert alert-info alert-dismissible fade show" role="alert">
        ...
        <strong>NB!</strong> Do ensure you have completely assigned subjects to their appropriate classes. If not, do so <a
    ...
    <form id="form" action="<?php echo e(route('create-result')); ?>" method="post">
        ...
        <div class="mb-4 form-group">
            ...
            <select style="width: 100%;height: 100%" name="student" style="height:50px !important" id="student"
                class="form-select select2" placeholder="Start typing..." required>
        ...
        <div class="mb-4 form-floating">
            ...
            <select name="class" class="form-select clid" id="classid" onChange="getSubject(this.value);"
                required="required">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        cas.onkeyup = function() {
            nosubmit()
        }
        exams.onkeyup = function() {
            nosubmit()
        }
