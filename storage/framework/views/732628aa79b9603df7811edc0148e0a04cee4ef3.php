            ...
            <tr class="">
                ...
                <td>
                    <?php switch($subject_combo->status):
                        case ('active'): ?>
                        <span class="text-success"><?php echo e(ucfirst($subject_combo->status)); ?></span>
                            <?php break; ?>

                        <?php default: ?>
                        <span class="text-danger"><?php echo e(ucfirst($subject_combo->status)); ?></span>
                        <?php break; ?>
                    <?php endswitch; ?>
                    </td>
                <td><a id="toggle" class='<?php switch($subject_combo->status):
                    case ('active'): ?>
                    text-vermillion
                        <?php break; ?>
                    ...
                    text-success
                    <?php break; ?>
                <?php endswitch; ?>  me-4' href="<?php echo e(route('toggle-subject-combo', $subject_combo->id)); ?>" title="<?php switch($subject_combo->status):
                    case ('active'): ?>
                    Deactivate
                        <?php break; ?>
                ...
                <?php endswitch; ?>
                    ...
                    <a class="text-danger" href="javascript:void" id="delete" data-subject="<?php echo e($subject_combo->subject->name); ?>" data-clas="<?php echo e($subject_combo->schoolClass->name); ?>" data-id='<?php echo e($subject_combo->id); ?>' title="Delete Record"><i class="fa-light fa-trash-alt"></i> Delete </a></td>
            </tr>
    ...
    swal.fire({
        ...
        if (result.value){
            ...
            .done(function(response){
                swal.fire('Oh Yeah!', "The subject combination <b><u>" + subject + "for "+ school_class + " </u></b> has been deleted successfully.", response.status);
