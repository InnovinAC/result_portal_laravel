...
<?php $__env->startSection('multi-select', route('delete-pin', 'multiple')); ?>
<?php $__env->startSection('itemName', 'pin'); ?>
...
<div class="table-responsive">
    <table id="tableData" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr class="">
                <td scope="row"><input type="checkbox" class="checkItem me-3" name="delete[]" value="<?php echo e($pin->id); ?>"> <?php echo e($loop->iteration); ?></td>
