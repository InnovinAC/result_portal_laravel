...
<?php $__env->startSection('content'); ?>
    <div class="mb-2 d-md-none d-print-none alert alert-primary">The table below can be scrolled from left to right on
        smaller screens.</div>
    ...
    <section id="printable">
        ...
        <div class='table-responsive'>
            <table id="tableData" class="caption-top table table-striped table-bordered" border="1" cellspacing="0"
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="me-3" href="<?php echo e(route('edit-student', $student->id)); ?>" title="Edit Record"><i
            ...
            <p> <input type="checkbox" id="checkAll"> <label for="checkAll" class="control-label">Select All</label>
            </p>
            <i class="fa-light fa-2x fa-level-up-alt fa-flip-horizontal"></i> With Selected:
