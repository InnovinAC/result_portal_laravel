...
<?php $__env->startSection('content'); ?>
    ...
    <h5 class="card-title">
           ...
           <br>
                                            <span class="text-24 font-weight-bolder">0</span>
        ...
        <div class="border border-1 mb-4 rounded p-2">
            <i class="fa-light text-vermillion fa-info-circle"></i> &nbsp;<a href="#form1" id="formButton"
                class="text-primary">Click here to quickly check a student's result</a>.
        </div>
        ...
        <div class="border mb-5  border-2 rounded p-2">
            <i class="fa-light text-vermillion fa-info-circle"></i> &nbsp;<a class="text-primary"
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\result_laravel\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>