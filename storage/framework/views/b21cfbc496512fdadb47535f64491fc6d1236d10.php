...
<?php $__env->startSection('header', 'Edit Teacher'); ?>
...
<form action="<?php echo e(route('edit-teacher', $id)); ?>" method="post">
    <?php echo csrf_field(); ?>
    <div class="form-floating mb-3">
      <input
      value="<?php echo e($teacher->username); ?>"
        type="text"
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-floating mb-3">
      <input
      value="<?php echo e($teacher->email); ?>"
        type="text"
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <select class="<?php $__errorArgs = ['class'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?> form-select" name="class" id="class">
            ...
            <option value="<?php echo e($school_class->id); ?>"
                <?php if(old('class') == $teacher->schoolClass->id): echo 'selected'; endif; ?>
                 <?php echo e($school_class->id == $teacher->schoolClass->id ? "selected":""); ?>><?php echo e($school_class->name); ?></option>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/innovin/Documents/projects/result_portal_laravel/resources/views/admin/edit/teacher.blade.php ENDPATH**/ ?>