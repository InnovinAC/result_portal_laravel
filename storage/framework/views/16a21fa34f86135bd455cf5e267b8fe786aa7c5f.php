...
<html lang="en">
    <head>
        <title><?php echo e($general->school_name); ?> - Admin Login</title>
      <meta charset="utf-8">
...
<!-- Stylesheets -->
 ...
 <link rel="stylesheet" href="<?php echo e(asset('/assets/fontawesome/css/all.min.css?2')); ?>" media="all" >
...
<!-- End Favicon -->
     <link href="<?php echo e(asset('assets/css/additional.css')); ?>" rel="stylesheet" media="all" />
    </head>
<body>
                ...
                <div class="user_card animate__animated animate__slow animate__zoomIn">
                    <div class="d-flex justify-content-center">
                        <div class="brand_logo_container">
                            <img src="<?php echo e(url('storage/uploads/image/logo.png')); ?>" class="brand_logo" alt="Logo">
                        </div>
                    </div>
                    <div class="d-flex justify-content-center form_container">
                        <form action="<?php echo e(url('/admin/login')); ?>" method="post">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                type="text" name="user" class="form-control <?php $__errorArgs = ['user'];
...
unset($__errorArgs, $__bag); ?>" value="" placeholder="">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <small class="text-vermillion"><?php echo e($message); ?></small>
                                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-floating mb-2">
                                ...
                                <input required autocomplete="off" type="password" name="password" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?> password" value="<?php echo e(old('password')); ?>" placeholder="">
...
<?php /**PATH /Users/innovin/Documents/projects/result_portal_laravel/resources/views/admin/login.blade.php ENDPATH**/ ?>