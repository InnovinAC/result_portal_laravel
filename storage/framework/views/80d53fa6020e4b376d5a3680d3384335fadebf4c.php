...
<nav class="navbar navbar-expand-lg navbar-dark bg-navy">
    <div class="container-fluid">
        ...
        <span class="toggler">
            <span id="toggler-icon" class="fa-thin navbar-toggler fa-bars fa-2x text-white"
        ...
        <div class="collapse text-white navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                ...
                <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo e(url('storage/uploads/admin/'.$user->image)); ?>" alt="hugenerd" width="30" height="30" class="rounded-circle">
                ...
                <li>
                    ...
                    <li><a id="logout" class="dropdown-item" href="<?php echo e(route('logout')); ?>" onclick="return confirm('Are you sure you want to logout?')"><i class="fa-thin fa-sign-out"></i> Sign out</a></li>
                </ul>
            </li>
        </div>
        </div>
</nav>
<?php /**PATH C:\xampp\htdocs\result_laravel\resources\views\admin\partials\navbar.blade.php ENDPATH**/ ?>