    ...
    <table id="tableData" class="table table-striped">
        ...
        <tbody>
            ...
            <tr class="">
                ...
                <td><a class="me-3" href="<?php echo e(route('edit-subject', ['id' => $subject->id])); ?>" title="Edit Record"><i
                    class="fa-light fa-edit"></i>Edit</a>
            <a type="button" title="Delete Record" class='text-vermillion' id="delete"
                data-name='<?php echo e($subject->name); ?>'  data-id='<?php echo e($subject->id); ?>'><i class="fa-thin fa-trash-alt"></i>Delete</a></td>
            </tr>
...
$(document).on('click', '#delete', function(){
    ...
    swal.fire({
        ...
        if (result.value){
            $.ajax({
                url: "<?php echo e(route('delete-subject', $subject->id)); ?>",
                type: 'POST',
