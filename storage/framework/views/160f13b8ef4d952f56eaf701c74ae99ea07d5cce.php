...
unset($__errorArgs, $__bag); ?> form-select" name="class" id="class">
            ...
            <option value="<?php echo e($school_class->id); ?>" <?php echo e($school_class->id == $teacher->schoolClass->id ? "selected":""); ?>><?php echo e($school_class->name); ?></option>
...
<?php echo $__env->make('admin.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\result_laravel\resources\views\admin\edit\teacher.blade.php ENDPATH**/ ?>