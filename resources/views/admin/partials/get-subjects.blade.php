...
<div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <strong>Sorry!</strong> No subjects have been assigned to <u>{{ $class_name }}</u> yet.
</div>
</div>
...
<div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
  ...
  <p>
<input type="hidden" name="subjectid[]" value="{{ $subject->subject->id }}"><b class="text-underline">{{ $subject->subject->name }}</b></p><br>
