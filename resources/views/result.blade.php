                ...
                <div class="card-header border-2 border-bottom bg-white">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-4">
                            ...
                            <img src="{{ url('storage/uploads/image/logo.png') }}" class="d-flex mx-auto mb-2"
                                width="100" height="100">
                        </div>
                        <div class="col-12 col-lg-4">


                            <h3 class="text-center font-weight-bolder  text-22 text-lb">{{ $general->school_name }}
                            </h3>
                            <h5 class="mb-2 text-26 text-center my-0">{{ $general->location }}
                                .</h5>
                        ...
                        <div class="col-12 col-auto col-lg-4">
                            ...
                            <img src="{{ url('storage/uploads/students/' . $result->student->image) }}"
...
<img style="display: block;border:1px solid grey;margin-left: auto;margin-top:4px;margin-buttom:4px;margin-right: auto;" width="200" class=" border my-4 rounded d-flex mx-auto img-fluid" src="students/"> -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ ucfirst($result->student->gender) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                        ...
                                        <tbody class="">
                                            @for ($i = 0; $i < $subjects->count(); $i++)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">{{ $subjects[$i]->name }}</td>
                                                    <td style="text-align: center">{{ $scores[$i][0] }}</td>
                                                    <td style="text-align: center">{{ $scores[$i][1] }}</td>

                                                    <td style="text-align: center">
                                                        {{ $scores[$i][0] + $scores[$i][1] }}</td>
                                            ...
                                            <tr>
                                                <th scope="row" colspan="5" style="text-align: center">Total
                                                    Marks</th>
                                                <td style="text-align: center"><b>{{ $total }}</b> out of
                                                    <b>{{ $out_of }}</b></td>
                                            </tr>
                                            <tr>
                                                <th scope="row" colspan="5" style="text-align: center">Average
                                                </th>
                                                <td style="text-align: center"><b>{{ $result->average }} %</b></td>
                                            </tr>
        ...
        <a class="btn btn-success mt-2" href="{{ route('check-result') }}">Back Home</a>
    </div>
